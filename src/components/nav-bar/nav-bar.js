    ...
    return (
      <nav>
        <Visibility once={false}
                    onBottomPassed={this.stickTopMenu} onBottomVisible={this.unStickTopMenu}>
            ...
            </Menu.Item>
            {
              this.state.userInfo ?
                <Menu.Item position={"right"}>
                  <Dropdown item simple text={`${this.state.userInfo.name}(${this.state.userInfo.id})`}>
    ...
    return (
      <div>
        <Dropdown simple icon={"sidebar"} direction={"left"}>
          <Dropdown.Menu style={{border: "none", boxShadow: "0 2px 5px 0px rgba(0, 0, 0, 0.2)"}}>
            <Dropdown item simple text='장소/장비 예약' href={"/reservation"} icon={null}>
              <Dropdown.Menu style={{border: "none", boxShadow: "0 2px 5px 0px rgba(0, 0, 0, 0.2)"}}>
                <Link to={"/reservation/place"}><Dropdown.Item as='a' text={"장소 예약"}/></Link>
                <Link to={"/reservation/equip"}><Dropdown.Item as='a' text={"장비 예약"}/></Link>
              </Dropdown.Menu>
            </Dropdown>
            <Dropdown item simple text='총학생회' href={"/association"} icon={null}>
              <Dropdown.Menu style={{border: "none", boxShadow: "0 2px 5px 0px rgba(0, 0, 0, 0.2)"}}>
                <Link to={"/association/introduce"}><Dropdown.Item as='a' text={"자치단체 소개"}/></Link>
                <Link to={"/association/board"}><Dropdown.Item as='a' text={"총학생회 게시판"}/></Link>
            ...
            <Dropdown item simple text='동아리' href={'/club'} icon={null}>
              <Dropdown.Menu style={{border: "none", boxShadow: "0 2px 5px 0px rgba(0, 0, 0, 0.2)"}}>
                <Link to={"/club/introduce"}><Dropdown.Item as='a' text={"동아리 소개"}/></Link>
                <Link to={"/club/board"}><Dropdown.Item as='a' text={"동아리 게시판"}/></Link>
              </Dropdown.Menu>
            </Dropdown>
          </Dropdown.Menu>
        </Dropdown>
        ...
        <Menu.Item>
          <Link to={"/white-book"}>
            <Dropdown item simple text='생활백서'>
              <Dropdown.Menu style={{border: "none", boxShadow: "0 2px 5px 0px rgba(0, 0, 0, 0.2)"}}>
                <Dropdown.Item text={"생활관 자치회"} href={"https://dorm.postech.ac.kr/"} target="_blank"/>
                <Dropdown.Item text={"배달업체"} href={"http://delivery.postech.ac.kr/"} target="_blank"/>
                {
                  this.props.userInfo ?
