...
export default class Footer extends Component {
  ...
  render() {
    return (
      <footer>
        <Segment vertical style={{margin: '0em 0em', padding: '2em 0em', backgroundColor: "none"}}>
          <Container textAlign='center'>
            <Grid divided stackable style={{fontSize: "small"}}>
              ...
              <Grid.Column width={4}>
                ...
                <Image src='/PoApper_logo.svg' size={"small"} centered href={"https://club.poapper.com/"} target="_blank"/>
                <List link>
              ...
              <Grid.Column width={4}>
                ...
                <List link>
                  <List.Item as='a' href="http://www.postech.ac.kr/" target="_blank">
                    포항공대 홈페이지
                  </List.Item>
                  <List.Item as='a' href="http://povis.postech.ac.kr/" target="_blank">
                    POVIS
                  </List.Item>
                  <List.Item as='a' href="https://hemos.postech.ac.kr/" target="_blank">
                    HEMOS
                  </List.Item>
                  <List.Item as='a' href="https://library.postech.ac.kr/" target="_blank">
                    박태준 학술정보관
                  </List.Item>
                </List>
              </Grid.Column>
