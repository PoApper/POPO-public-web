...
export default class PrivacyPolicy extends Component {
  render() {
    return (
      <section style={{margin: "0 2em", padding: "3vh 3vw", background: "#f6f6f6"}}>
        <h2>개인정보 처리방침</h2>
        ...
        <p>▶ 개인정보 보호책임자<br/>
          성명 : 이정우<br/>
          직책 : 총학생회 비상대책위원장<br/>
          연락처 : 054-279-2621, <a href="mailto:stu-35@postech.ac.kr">stu-35@postech.ac.kr</a>,<br/>
          ※ 개인정보 보호 담당부서로 연결됩니다.</p>
        <p>▶ 개인정보 보호 담당부서<br/>
          부서명 : 총학생회 비상대책위원회<br/>
          담당자 : 이정우<br/>
          연락처 : 054-279-2621, <a href="mailto:stu-35@postech.ac.kr">stu-35@postech.ac.kr</a>,</p>
