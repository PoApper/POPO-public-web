...
export default class DevelopInfo extends Component {
  render() {
    return (
      <section style={{background: "#eeeeee", borderRadius: "0.4em"}}>
        <Container style={{padding: "3vh"}}>
          ...
          <p>
            <strong>Contact Us</strong> : Lead Developer, 하석윤(컴공 18) <a href={"https://github.com/BlueHorn07"}><Icon
            name={'github'}/></a> <Popup content={"hsy4462@postech.ac.kr"} trigger={<Icon name={'mail'}/>}/>
          </p>
